      ...
      <div className="widgetContainer">
        <div className="widget">
          <div className="widgetTitle">
            ...
            <Link to='/sd-dashboard/files' className='viewAllBtn'>View All</Link>
          </div>
          <div className="widgetContent">
            <FileItem title="Math Practice Test 3" date="Apr 10, 2025" subject="Mathematics" />
            <FileItem title="Science Notes - Chapter 5" date="Apr 8, 2025" subject="Science" />
            <FileItem title="Language Arts Essay Draft" date="Apr 5, 2025" subject="Language Arts" />
            <FileItem title="Social Studies Flashcards" date="Apr 2, 2025" subject="Social Studies" />
          </div>
        </div>
        ...
        <div className="widget">
          <div className="widgetTitle">
            <h2>Last Messages</h2>
            <Link to='/sd-dashboard/inbox' className='viewAllBtn'>View All</Link>
          </div>
          <div className="widgetContent">
            <MessageItem sender="Albert" date="Apr 14, 2025" preview="Updated Document" />
            <MessageItem sender="Mike" date="Apr 13, 2025" preview="Birth certificate" />
            <MessageItem sender="Jhon" date="Apr 12, 2025" preview="Rapport" />
          </div>
        </div>
      </div>
